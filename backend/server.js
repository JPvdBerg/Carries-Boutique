...
// 1. ADDED: Health Check Route
// This route responds immediately with 200 OK for Render's monitoring.
app.get('/', (req, res) => {
    // Render health checks will hit this path
    res.status(200).send('Carries Boutique Server is running!'); 
});
...
app.post('/api/send-order', async (req, res) => {
    ...
    // --- Validation and Receipt Generation (Unchanged) ---
    // (Ensure customer object and cart exist here)
    ...
    const msg = {
      ...
      text: `Thank you for your order, ${customer.name}! Your total was R${total.toFixed(2)}.`, // Fallback
...
// 2. MODIFIED: Bind to 0.0.0.0 host for Render compatibility
